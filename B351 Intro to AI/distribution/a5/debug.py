...
class debug:
    ...
    def debug_informationGain(self):
        ...
        ig_test = calc_information_gain(parent_classifications, {1: child1_classifications, 2: child2_classifications},
                                        {1: 3, 2: 5})
        print(ig_test)
    ...
    def debug_knn_classifier(self):
        ...
        TRAINING_LENGTH = 25000  # we'll train on 2,000 points
        VALIDATION_LENGTH = 3000  # we'll us 500 points as validation data
        ...
        validation_points, validation_labels = income_points[
                                               TRAINING_LENGTH:TRAINING_LENGTH + VALIDATION_LENGTH], income_labels[
                                                                                                     TRAINING_LENGTH:TRAINING_LENGTH + VALIDATION_LENGTH]

        basic_1nn = KNN_Classifier(k=1)
        basic_3nn = KNN_Classifier(k=10)
